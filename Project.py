...
class Child(tk.Toplevel):
    ...
    def init_child(self):
        ...
        # подписи
        label_name = tk.Label(self, text='Фамилия Имя Отчество:')
        label_name.place(x=50, y=50)
        label_select = tk.Label(self, text='Номер телефона')
        label_select.place(x=50, y=80)
        label_sum = tk.Label(self, text='Электронная почта')
        label_sum.place(x=50, y=110)
        label_pay = tk.Label(self, text='Оклад')
...
class Search(tk.Toplevel):
    ...
    def init_search(self):
        ...
        label_search = tk.Label(self, text='Найти')
